...
class Audio(Base):
    ...
    tab_generation_id = Column(
        Integer, ForeignKey("tab_generation.id"), nullable=True, index=True
    )
    ...
    tab_generation = relationship(
        "TabGeneration", back_populates="audio", uselist=False
    )
