...
class TextEntry(Base):
    ...
    language = Column(Enum("vi", "en", name="language_enum"), nullable=True)
    ...
    tab_generation = relationship("TabGeneration", back_populates="text_entry", uselist=False)
